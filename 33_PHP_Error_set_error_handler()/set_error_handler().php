...
{
	echo "Error: [$errno] $errstr";			//$errno: 2, $errstr: fopen(not_exist_file.txt) [<a href='function.fopen'>function.fopen</a>]: failed to open stream: No such file or directory
}
