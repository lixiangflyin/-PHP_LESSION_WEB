...
/*****************************************************/
/**修改人RobinGuo修改目的:动态绑定选择事件          **/
/*****************************************************/
		//自定义OnSelect事件
		registerOnSelect:function(method){
		p.onSelected=method;
		temp = method;
		},
		selectMethod:function(method){ alert(temp);
		},
		//自定义设置comboBox默认选项
		changeSelectValue: function(newValue, newText) {
...
/*******************************************************/
$("input[name!=" + g.textFieldID + "][name!=" + g.textFieldID + "_val][name!=" + g.textFieldID + "_valof]+[class=l-box-select],.l-box-dateeditor").hide('fast'); 
/**************************************************/
