...
*/
 $(document).ready(function() {
	 (function(w){if(w.screen.availWidth>=1400)document.body.className = 'wrap_1400';})(window);
 });
...
(function ($)
{
    ...
    $.fn.ligerDateEditor = function (options)
    {
        return this.each(function ()
        {
            ...
            dateeditorHTML += "<iframe style='position:absolute;width:200px;height:200px;z-index:-1;visibility:hidden;'></iframe>";
	    ...
	    /*****************************************************/
	    /**修改人RobinGuo修改目的:日期下拉框默认选择当前日期**/
	    /*****************************************************/
	    		if(g.selectedDate == null)
				{			
					g.selectedDate = {
                                           year: g.now.year,
                                           month: g.now.month,
	    ...
	    /****************************************************/
            ...
            *************/
            ...
            {
/*******************************************************/
/**修改人RobinGuo修改目的:防止点击后其它下拉框不收回去**/
/*******************************************************/
$("input[name!=" + g.textFieldID + "][name!=" + g.textFieldID + "_val]+[class=l-box-select],.l-box-dateeditor").hide('fast'); 
/**************************************************/
                g.bulidContent();
