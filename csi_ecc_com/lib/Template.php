...
/*
  function replaceVersion($match){
    if(!empty($match[1])){
      if($match[2] == 'JS'){
        return isset(ConfigVersion::$Javascript[$match[3]]) ? ConfigVersion::$Javascript[$match[3]] : '';
      } else if($match[2] == 'CSS'){
        return isset(ConfigVersion::$CSS[$match[3]]) ? ConfigVersion::$CSS[$match[3]] : '';
      }
    }
    return $match[0];
  }*/
