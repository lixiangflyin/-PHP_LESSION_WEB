 ...
 * 对TTC:t_ad_itemdetail的赠、查、删、改等操作
 * 
...
$_TTC_CFG['IAdItemDetailTTC']['FIELDS']	= array();//数据类型，int=1,string=2,binary=3
...
$_TTC_CFG['IAdItemDetailTTC']['FIELDS']['fid'] = array('type' => 1, 'min' => 0, 'max' => 4294967295); //若当前记录属于某组，则fid为组的id；若当前记录不属于任何组，则fid为0
